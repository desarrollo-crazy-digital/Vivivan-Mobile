  ...
  return (
    <ScrollView className="flex-1 bg-slate-50 p-4">
      ...
      <View className="flex-row justify-between mt-4 mb-12">
        <Button title="Atrás" variant="outline" onPress={() => navigatePrev(router, 7)} className="w-[45%]" />
        <Button title="Siguiente" variant="primary" onPress={() => navigateNext(router, 7)} className="w-[45%]" />
      </View>
    </ScrollView>
  );
}
